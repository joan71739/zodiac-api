...
class ClientServiceTest {
   ...
   @Mock
    ...
    void setUp() {
        ...
        sampleClient.setAscDegreeNum((short) 22);
        sampleClient.setAscMinuteNum((short) 1);
        sampleClient.setMcSign("巨蟹座");
        sampleClient.setMcDegreeNum((short) 22);
        sampleClient.setMcMinuteNum((short) 35);
    }
 
    // ── GET ALL ─────────────────────────────────────────
 
    @Test
    @DisplayName("取得所有客戶 — 回傳正確數量")
    ...
    void getById_existing_returnsClient() {
        ...
        assertThat(result.getAscDegreeNum()).isEqualTo((short) 22);
    ...
    void create_savesAndReturnsClient() {
        ...
        // v9：四軸資訊
        req.setAscSign("射手座");
        req.setAscDegreeNum((short) 5);
        req.setAscMinuteNum((short) 10);
        req.setMcSign("處女座");
        req.setMcDegreeNum((short) 3);
        req.setMcMinuteNum((short) 45);
        ...
        saved.setAscDegreeNum((short) 5);
        saved.setAscMinuteNum((short) 10);
        saved.setMcSign("處女座");
        saved.setMcDegreeNum((short) 3);
        saved.setMcMinuteNum((short) 45);
    ...
    void update_updatesFieldsCorrectly() {
        ...
        // v9：更新四軸資訊
        req.setAscSign("水瓶座");
        req.setAscDegreeNum((short) 10);
        req.setAscMinuteNum((short) 5);
        req.setMcSign("天蠍座");
        req.setMcDegreeNum((short) 8);
        req.setMcMinuteNum((short) 20);
        ...
        assertThat(sampleClient.getAscDegreeNum()).isEqualTo((short) 10);
        assertThat(sampleClient.getMcSign()).isEqualTo("天蠍座");
        assertThat(sampleClient.getMcDegreeNum()).isEqualTo((short) 8);
    }
